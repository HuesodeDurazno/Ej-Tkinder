...
img1 = ImageTk.PhotoImage(Image.open(r'carrusel\images\1.jpg'))
img2 = ImageTk.PhotoImage(Image.open(r'carrusel\images\2.jpg'))
img3 = ImageTk.PhotoImage(Image.open(r'carrusel\images\3.jpg'))
img4 = ImageTk.PhotoImage(Image.open(r'carrusel\images\4.jpg'))
